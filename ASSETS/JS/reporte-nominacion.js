...
// =================================================
const NOM_DATA = [
  { id:'NOM001', per:'PER/09461-25', cliente:'Sandra Motors',  locacion:'Callao',   estado:'Activo',    factura:'Pendiente',  inicio:'02/05/2025', fin:'02/09/2025', compartida:false,
    detalles:[
  ...
  { id:'NOM002', per:'PER/09462-25', cliente:'PETROPERÚ',      locacion:'Mollendo', estado:'Activo',    factura:'Facturado',  inicio:'15/04/2025', fin:'15/08/2025', compartida:true,
    detalles:[
  ...
  { id:'NOM003', per:'PER/09463-25', cliente:'REPSOL',         locacion:'ILO',      estado:'Inactivo',  factura:'Anulado',    inicio:'10/03/2025', fin:'10/07/2025', compartida:false,
    detalles:[
      { ref:'Acuerdo Global', servicios:'Control de Temperatura',    producto:'Petróleo Crudo',  costo:'S/ 2,900', costoAct:'S/ 2,900' },
    ]},
  { id:'NOM004', per:'PER/09464-25', cliente:'MOBIL',          locacion:'Callao',   estado:'Activo',    factura:'Pendiente',  inicio:'01/05/2025', fin:'01/09/2025', compartida:false,
    detalles:[
  ...
  { id:'NOM005', per:'PER/09465-25', cliente:'PRIMAX',         locacion:'Pisco',    estado:'Finalizado',factura:'Facturado',  inicio:'20/01/2025', fin:'20/04/2025', compartida:true,
    detalles:[
      { ref:'Contrato',       servicios:'Inspección Visual',         producto:'Gasolina 90',     costo:'S/ 2,100', costoAct:'S/ 2,100' },
    ]},
  { id:'NOM006', per:'PER/09461-25', cliente:'Sandra Motors',  locacion:'Callao',   estado:'Finalizado',factura:'Facturado',  inicio:'10/02/2025', fin:'10/05/2025', compartida:false,
    detalles:[
  ...
  { id:'NOM007', per:'PER/09466-25', cliente:'EXXON MOBIL',    locacion:'Ica',      estado:'Activo',    factura:'Pendiente',  inicio:'05/05/2025', fin:'05/09/2025', compartida:false,
    detalles:[
  ...
  { id:'NOM008', per:'PER/09467-25', cliente:'PETROPERÚ',      locacion:'Mollendo', estado:'Finalizado',factura:'Facturado',  inicio:'01/01/2025', fin:'01/04/2025', compartida:true,
    detalles:[
      { ref:'Contrato',       servicios:'Certificación de Calidad',  producto:'Petróleo Crudo',  costo:'S/ 7,800', costoAct:'S/ 7,800' },
    ]},
  { id:'NOM009', per:'PER/09468-25', cliente:'REPSOL',         locacion:'Callao',   estado:'Activo',    factura:'Pendiente',  inicio:'18/05/2025', fin:'18/10/2025', compartida:false,
    detalles:[
  ...
  { id:'NOM010', per:'PER/09469-25', cliente:'MOBIL',          locacion:'Ilo',      estado:'Finalizado',factura:'Facturado',  inicio:'15/02/2025', fin:'15/05/2025', compartida:false,
    detalles:[
      { ref:'Contrato',       servicios:'Pesaje y Medición',         producto:'Petróleo Crudo',  costo:'S/ 5,600', costoAct:'S/ 5,600' },
    ]},
  { id:'NOM011', per:'PER/09462-25', cliente:'PETROPERÚ',      locacion:'Callao',   estado:'Activo',    factura:'Facturado',  inicio:'22/04/2025', fin:'22/08/2025', compartida:true,
    detalles:[
  ...
  { id:'NOM012', per:'PER/09470-25', cliente:'PRIMAX',         locacion:'Pisco',    estado:'Finalizado',factura:'Facturado',  inicio:'05/03/2025', fin:'05/06/2025', compartida:false,
    detalles:[
      { ref:'Contrato',       servicios:'Muestreo en Buque',         producto:'Diésel B5',       costo:'S/ 4,200', costoAct:'S/ 4,200' },
    ]},
  { id:'NOM013', per:'PER/09471-25', cliente:'Sandra Motors',  locacion:'Ica',      estado:'Inactivo',  factura:'Anulado',    inicio:'28/03/2025', fin:'28/06/2025', compartida:false,
    detalles:[
      { ref:'Cotización',     servicios:'Control de Calidad',        producto:'Gasolina 90',     costo:'S/ 1,600', costoAct:'S/ 1,600' },
    ]},
  { id:'NOM014', per:'PER/09472-25', cliente:'EXXON MOBIL',    locacion:'Callao',   estado:'Activo',    factura:'Pendiente',  inicio:'12/05/2025', fin:'12/09/2025', compartida:false,
    detalles:[
  ...
  { id:'NOM015', per:'PER/09473-25', cliente:'REPSOL',         locacion:'Mollendo', estado:'Finalizado',factura:'Facturado',  inicio:'18/01/2025', fin:'18/04/2025', compartida:true,
    detalles:[
